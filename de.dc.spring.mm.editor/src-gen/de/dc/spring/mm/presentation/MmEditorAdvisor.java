...
import de.dc.spring.mm.presentation.MmEditorPlugin;
...
public final class MmEditorAdvisor extends WorkbenchAdvisor {
	...
	private static String getString(String key, Object s1) {
		return de.dc.spring.mm.presentation.MmEditorPlugin.INSTANCE.getString(key, new Object[] { s1 });
	}
	...
	public static class Perspective implements IPerspectiveFactory {
		 ...
		 * @generated
		 */
		public static final String ID_PERSPECTIVE = "de.dc.spring.mm.presentation.MmEditorAdvisorPerspective";
